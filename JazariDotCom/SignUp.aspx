            ...
            <div id="formContainer" class="mx-auto auth-shadow">
                <div id="login-form" class="grid" >
                    <div class="grid">
                        ...
                        <div class="grid">
                            <input class="s-input" placeholder="Enter Name" type="text" runat="server" name="displayname" id="displayname">
                    ...
                    <div class="grid">
                        ...
                        <div class="grid">
                            <input class="s-input" id="email" type="email" runat="server"
                                size="30" maxlength="100" name="email"
                    ...
                    <div class="grid-reverse">
                        <div class="grid js-password">
                            ...
                            <input class="s-input" type="password" placeholder="****************"
                                minlength="8" maxlength="32"
                                autocomplete="off" runat="server" name="password" id="password">
                                    <span class="error" id="password-error" aria-live="polite"></span>

                        </div>
                    </div>
                    <div class="grid">
                        <asp:Button runat="server" CssClass="s-btn__primary" ID="btnSignUp" Text="Sign Up" OnClick="btnSignUp_Click" />
                        <p class="s-input-message js-error-message d-none"></p>

                        <asp:Label ID="lable_signup" runat="server">
